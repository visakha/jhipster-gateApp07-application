...
public class GateApp07KafkaResourceIT {
    ...
    @Autowired
    private GateApp07KafkaProducer producer;

    @Autowired
    private GateApp07KafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GateApp07KafkaResource kafkaResource = new GateApp07KafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gate-app-07-kafka/publish?message=test"))
